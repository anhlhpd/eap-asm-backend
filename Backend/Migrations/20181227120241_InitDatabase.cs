    ...
    public partial class InitDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2018, 12, 27, 19, 2, 40, 982, DateTimeKind.Local), new DateTime(2018, 12, 27, 19, 2, 40, 982, DateTimeKind.Local), null, "Admin", 1, new DateTime(2018, 12, 27, 19, 2, 40, 982, DateTimeKind.Local) });

            migrationBuilder.InsertData(
                table: "Account",
                columns: new[] { "AccountId", "AccountStatus", "CreatedAt", "DeletedAt", "Email", "Password", "Salt", "UpdatedAt", "Username" },
                values: new object[] { "ADMIN", 1, new DateTime(2018, 12, 27, 19, 2, 40, 963, DateTimeKind.Local), new DateTime(2018, 12, 27, 19, 2, 40, 965, DateTimeKind.Local), "admin@admin.com", "X4qagf71TdKwmOMtE9cnFDqp9oRy2cpMv3t+Lzt6vTI=", "ULloT5GpI0tcug2jRRmRBA==", new DateTime(2018, 12, 27, 19, 2, 40, 965, DateTimeKind.Local), "ADMIN" });
